...
class CarWindow(QMainWindow, Ui_MainWindow):
    ...
    def ParametersRead(self):
        if self.Motor_tabWidget.currentIndex() == 0:
            ...
            # 电机1 目标位置读取
            Data = self.UartRead_int16(self.TargetPos_Addr_H[0]) << 16 | self.UartRead_int16(self.TargetPos_Addr_L[0])
    ...
    def ParametersWrite(self):
        if self.Motor_tabWidget.currentIndex() == 0:
            ...
            self.UartWrite_int16(self.TargetPos_Addr_H[0], Data / 65536)
            self.UartWrite_int16(self.TargetPos_Addr_L[0], Data % 65536)
        else:
            return
